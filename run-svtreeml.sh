...
#code/svtreeml -c $input -t $times -s $Ns -p $Npop -g $Ngen -e $Nstop -o results-maxL-tree.txt -x 0.025
#Rscript ana/plot-trees-single.R results-maxL-tree.txt 0 #>& /dev/null

code/svtreemu -c $input -t $times -p results-maxL-tree.txt -s $Ns -x 0.025 -l 0.5 -o results-maxL-mu-tree.txt -m 2000 -r 0.01
